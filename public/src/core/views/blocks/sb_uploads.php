<div v-if="edit" id="sb_uploads" style="padding: 0 0.8em" class="sb_content">
  ...
  <div class="dummy_components">
    <span v-for="(com,i) in upload_components" :data-name="com.name" class="dummy_component"
    :style="{'background-image':'url('+com.image+')'}"
    :data-tag="com.tag" :data-html="com.html" :data-style="com.style">
    </span>
  </div>
