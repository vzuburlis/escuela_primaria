<?php
  ...
  $data['postsText'] = __('Posts', ['es' => 'Publicaciones','el' => 'Δημοσιεύσεις']);
  $data['usersText'] = __('Users', ['es' => 'Usuarios','el' => 'Χρηστες']);
  $data['pagesText'] = __('Pages', ['es' => 'Páginas','el' => 'Σελίδες']);
  $data['packagesText'] = __('Packages', ['es' => 'Paquetes','el' => 'Πακέτα']);
  ...
  <div>
    <a href="admin/content/post">
      <div>
        ...
        <span><?=__('Posts', ['es' => 'Publicaciones','el' => 'Δημοσιεύσεις'])?></span>
  ...
  <div>
    <a href="admin/users">
      <div>
        ...
        <span><?=__('Users', ['es' => 'Usuarios','el' => 'Χρηστες'])?></span>
  ...
  <div>
    <a href="admin/content/page">
      <div>
        ...
        <span><?=__('Pages', ['es' => 'Páginas','el' => 'Σελίδες'])?></span>
  ...
  <div>
    <a href="admin/packages">
      <div>
        ...
        <span><?=__('Packages', ['es' => 'Paquetes','el' => 'Πακέτα'])?></span>
