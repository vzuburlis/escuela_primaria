...
$areaStyle = "display:grid; grid-template-columns:repeat(auto-fill,minmax(250px, 1fr));";
$areaStyle = 'padding:0 8px;display: inline-flex;text-align:' . htmlentities($data['text-align'] ?? 'left');
